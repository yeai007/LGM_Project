 ...
 * 类描述：
 * 创建人：whisper
 * 创建时间：2016/9/29 14:01
 * 修改人：whisper
 * 修改时间：2016/9/29 14:01
 * 修改备注：
 */
public class UpdateUserInfo extends JsonBase {
    public String UserId, NickName, Field;
    String TAG = "DataForHttp";
    public String Type;

    public UpdateUserInfo() {
        super(optString);
        interfaceUrl = Const.BASE_URL + "UpdateUserInfo.php";
    }
    ...
    public void PacketData() {
        try {
            ...
            opt_map.put("NickName", NickName);
            opt_map.put("Field", Field);
        } catch (Exception e) {
            Log.e(LogTAG, e.getMessage());
        }
