...
public class MembersInChatActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGroupId = getIntent().getLongExtra(Application.GROUP_ID, 0);
        mIsDeleteMode = getIntent().getBooleanExtra(Application.DELETE_MODE, false);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.return_btn:
                    ...
                    setResult(Application.RESULT_CODE_ALL_MEMBER, intent);
                    finish();
                    break;
                case R.id.right_btn:
                    if (mIsDeleteMode) {
