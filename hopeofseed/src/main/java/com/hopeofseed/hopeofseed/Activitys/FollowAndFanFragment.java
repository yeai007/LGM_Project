 ...
 * 类描述：
 * 创建人：whisper
 * 创建时间：2016/12/27 8:44
 * 修改人：whisper
 * 修改时间：2016/12/27 8:44
 * 修改备注：
 */
public class FollowAndFanFragment extends Fragment implements NetCallBack, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.follow_and_fan_fragment, null);
        initList(v);
        getData();
        return v;
