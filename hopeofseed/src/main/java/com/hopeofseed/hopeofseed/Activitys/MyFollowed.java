 ...
 * 修改备注：
 */
public class MyFollowed extends AppCompatActivity implements View.OnClickListener,NetCallBack{
    ...
    private void getMyFollow() {
        ...
        hu.httpPost(Const.BASE_URL + "getMyFollowed.php", opt_map, FollowedFriendTmp.class, this);
    }
