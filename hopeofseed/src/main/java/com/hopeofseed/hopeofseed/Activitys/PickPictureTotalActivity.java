...
import com.hopeofseed.hopeofseed.Adapter.AlbumListAdapter;
import com.hopeofseed.hopeofseed.Application;
import com.hopeofseed.hopeofseed.R;
import com.hopeofseed.hopeofseed.ui.chatting.BaseActivity;
import com.hopeofseed.hopeofseed.ui.entity.ImageBean;
import com.hopeofseed.hopeofseed.ui.tools.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				startActivityForResult(mIntent, Application.REQUEST_CODE_SELECT_ALBUM);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Application.RESULT_CODE_SELECT_ALBUM) {
			setResult(Application.RESULT_CODE_SELECT_PICTURE, data);
			finish();
		}
	}
