...
import com.hopeofseed.hopeofseed.Adapter.PickPictureAdapter;
...
public class PickPictureActivity extends BaseActivity {
    ...
    private OnItemClickListener onItemListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> viewAdapter, View view, int position, long id) {
            ...
            intent.putExtra(Application.POSITION, position);
            ...
            startActivityForResult(intent, Application.REQUEST_CODE_BROWSER_PICTURE);
        }
    };
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Application.RESULT_CODE_SELECT_PICTURE) {
            if (data != null) {
        ...
        } else if (resultCode == Application.RESULT_CODE_BROWSER_PICTURE) {
            setResult(Application.RESULT_CODE_SELECT_ALBUM, data);
            finish();
        }
    }
            ...
            if (activity != null) {
                switch (msg.what) {
                    case SEND_PICTURE:
                        ...
                        activity.setResult(Application.RESULT_CODE_SELECT_ALBUM, intent);
