 ...
 * 修改备注：
 */
public class BreedOrganizationListFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = "ExperienceFragment";
    RecyclerView recy_list;
    static CropDataAdapter mCropDataAdapter;
    static ArrayList<CropData> arrCropData = new ArrayList<>();
    static ArrayList<CropData> arrCropDataTmp = new ArrayList<>();
    ...
    public static BreedOrganizationListFragment newInstance(String strSearch, String userId) {
        BreedOrganizationListFragment f = new BreedOrganizationListFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.search_list_breedorganization_fragment, null);
        initList(v);
        getData(Str_search);
        return v;
    }
    ...
    private void initList(View v) {
        ...
        mCropDataAdapter = new CropDataAdapter(getContext(), arrCropData, false);
...
/*                        RecyclerViewAdapter adapter = (RecyclerViewAdapter) recy_news.getAdapter();
    ...
    private void getData(String Str_search) {
        ...
        hu.httpPost(Const.BASE_URL + "GetBreedOrganizationByUser.php", opt_map, CropDataTmp.class, netCallBack);
    }
    ...
    NetCallBack netCallBack = new NetCallBack() {
        ...
        public void onSuccess(RspBaseBean rspBaseBean) {
            ...
            CropDataTmp mUserDataNoRealmTmp = ObjectUtil.cast(rspBaseBean);
            arrCropDataTmp = mUserDataNoRealmTmp.getDetail();
    ...
    Runnable updateList = new Runnable() {
        ...
        public void run() {
            ...
            arrCropData.addAll(arrCropDataTmp);
