 ...
 * 类描述：
 * 创建人：whisper
 * 创建时间：2016/11/20 13:01
 * 修改人：whisper
 * 修改时间：2016/11/20 13:01
 * 修改备注：
 */
public class CommendData {
     ...
     * UserId : 1117
     * Comment : 一级评论
     * RecordCreateTime : 2016-11-20 07:42:57
     * RecordFlag : 0
     * user_id : 1117
    ...
    public String getFromNewId() {
        return FromNewId;
    }

    public void setFromNewId(String FromNewId) {
        this.FromNewId = FromNewId;
    }
   ...
   /* public ArrayList<Commend2Data> getSecondcommend() {
        return secondcommend;
    }

    public void setSecondcommend(ArrayList<Commend2Data> secondcommend) {
        this.secondcommend = secondcommend;
    }*/
}
