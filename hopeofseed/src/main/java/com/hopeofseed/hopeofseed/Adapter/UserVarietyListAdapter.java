 ...
 * 修改备注：
 */
public class UserVarietyListAdapter extends BaseAdapter {
    Context mContext;
    List<UserVarietyData> mList;

    public UserVarietyListAdapter(Context context, List list) {
        super();
