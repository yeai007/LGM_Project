...
public class TimeCountUtil extends CountDownTimer {
	...
	public void onTick(long millisUntilFinished) {
		...
		// R.drawable.btn_getcode_hou));
		btn.setBackgroundResource(R.drawable.btn_getcode_hou);
	...
	public void onFinish() {
		...
		//2015.11.11 修改
		// btn.setBackground(mActivity.getResources().getDrawable(
		// R.drawable.btn_getcode_qian));// 还原背景色
		btn.setBackgroundResource(R.drawable.btn_getcode_qian);
	}
